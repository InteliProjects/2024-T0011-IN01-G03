...
class Quiz extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('resetContent1', './src/assets/botões/resetContent.png');
        ...
        this.load.image('sequenciaquiz2','./src/assets/quiz/quiz33.png');
        this.load.image('enunciado','./src/assets/quiz/pergunta22.png');
        this.load.image('quizblur','./src/assets/quiz/quizborrado.png');
        this.load.image('gameOverBt', './src/assets/quiz/gameOverBT.png');
        this.load.image('gameWinBt','./src/assets/quiz/gameWinBT.png');
        this.load.image('resetContent2', './src/assets/quiz/ResetContent3.png');
        this.load.image('resetQuiz', './src/assets/quiz/ResetQuiz.png');
    }

    // criação dos elementos da cena
    create() {

        medalhaState.bmQuizz1 = (true)
        gameState.iniciouQuizz = (true)
        // background com a pergunta 
        this.add.image(larguraJogo / 2, alturaJogo / 2, 'oCard1').setDepth(1);
        this.sequenciaquiz = this.add.image(larguraJogo / 2, 650, 'sequenciaquiz2').setDepth(1).setScale(0.7);
        ...
        this.gameControls.resetWinBT = this.add.image(larguraJogo / 2, alturaJogo / 2 + 300, 'resetQuiz').setScale(1.7).setInteractive().setVisible(false).setDepth(6);
    ...
    wrongAnswer() {
        ...
        this.resetContent = this.add.image(larguraJogo / 2, alturaJogo/ 2 + 300, 'resetContent1').setScale(1.7).setInteractive().setVisible(true).setDepth(6);
