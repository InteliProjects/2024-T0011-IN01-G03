...
class Quiz2 extends Phaser.Scene {
    ...
    preload() {
        ...
        this.load.image('sequenciaquiz','./src/assets/quiz/quiz22.png');
        this.load.image('enunciado','./src/assets/quiz/pergunta22.png');
        this.load.image('quizblur','./src/assets/quiz/quizborrado.png');
        this.load.image('medalhaquiz1','./src/assets/medalhas/quiz1medalha.png');
    }
    ...
    create() {
        ...
        this.sequenciaquiz = this.add.image(larguraJogo / 2, 650, 'sequenciaquiz').setDepth(1).setScale(0.7);
    ...
    rightAnswer() {
        ...
        this.add.image(larguraJogo / 2, alturaJogo / 5, 'medalhaquiz1').setScale(.8).setDepth(6);
